const episodeData = {
    ...
    "frames": [
        ...
        },
        {
            ...
            "overlay_texts": [
                "Rain-Maker-Station. Der Ertrag des Morgens leuchtet auf den transparenten Anzeigen: 89 %. Gesunken von den 94 % von gestern. Der Rückgang folgt einem mathematischen Muster, das Elara als vorsätzlich erkennt.",
                "Die Nachricht trifft über die Geisterwandler-Kanäle ein: Handelsprinz Zevs Finanzierungsgespräche mit Nova Terra sind nicht länger privat. Die Siedler-Koalition ist so sauber zerbrochen, wie Reif Stein spaltet.",
                "Elaras Vitalis-Partnerschaft flammt in ihrem Zorn blutrot auf. Die Harmonie, die sie ins Leben gesungen haben, war niemals authentisch. Es war vorab arrangierte Zustimmung, die sich als Verbindung tarnte.",
                "Der Tau-Ertrag sinkt. 87 %. Das Wasserbewusstsein entzieht seine Zustimmung. Das Ökosystem selbst reagiert auf den gebrochenen Pakt.",
                "Ihr Kommunikations-Spike klemmt. Kein mechanisches Versagen, sondern gezieltes Verstummen. Sie wird isoliert. Oder beschützt. Mehrere Minuten lang spricht Elara nicht."
            ]
        },
        {
            "id": 9678,
        ...
        },
        {
            ...
            "overlay_texts": [
                "Crater City. Arterial Bone. Kaelen ist mit einem Thron aus dunklem Kohlenstoff verschmolzen. Chrono-Energie-Adern pulsieren durch synthetisches Fleisch. Die Kammerwände reißen in ein hexagonales Gitter aus zeitlicher Belastung.",
                "Seine behandschuhte Hand zittert. Das physische Brennen des Tethers. Vierzig Jahre Verhandlung haben das Zittern hinterlassen, die skelettartige Sparsamkeit, die Leere hinter seinen bernsteinfarbenen Augen.",
        ...
        },
        {
            ...
            "overlay_texts": [
                "Kanal-Bistro in Crater City. Die Obsidianwände schwitzen Mineralwasser aus. Melori sitzt am Kopfende eines Tisches aus gepressten Schilffasern. Jede Fingerspitze leuchtet in sanftem Violett.",
                "Sie teilt drei Kontakten Fakten zu. Niemals nennt sie die Kontamination ein Muster. Niemals verbindet sie die drei Symptome zu einer einzigen Diagnose.",
                "MELORI: „Der Schorf meldet unerschöpfliche Wurzelkrankheit. Der Drift zeigt Phänotyp-Abweichungen in der Fracht. Die Algentanks von Vortex erleben einen kaskadierenden Zusammenbruch des Immunsystems.“",
                "VORTEX-BÜROKRAT: „Sie kennen das Muster bereits.“\n\nMELORI: „Wissen ist keine Macht. Wissen ist die Voraussetzung für Macht.“",
                "MELORI: „Ich werde euch zeigen, warum alle drei unzureichend sind, bis sie integriert werden. In drei Tagen bringt ihr mir eure vollständigen Inventarlisten.“"
            ]
        },
        {
            "id": 9684,
        ...
        },
        {
            ...
            "overlay_texts": [
                ...
                "Die Federn des Greifen tragen nun das Bernsteinleuchten. Bernstein ist die Farbe der Chrono-Energie. Die Farbe der Konsequenz. Die Farbe dessen, was bereits vierzig Jahre vor der Entscheidung entschieden wurde.",
                "Eve schließt ihre Augen. Der Dschungel oben atmet im Schlaf. Die Sporen treiben. Die bernsteinfarbenen Federn halten stand."
            ]
        }
    ],
    ...
    "episode_cover": "https://raw.githubusercontent.com/sebastianpw/sg_showcase_01/main/cinemagic_hub/sg-tac/assets/frame0058052.jpg",
    "episode_cover_raw": "/frames_starlightguardians_nu/frame0058052.jpg",
    "next_teaser": {
        "type": "next_episode",
        "title": "SERIES PRE S03",
        "cover": "https://raw.githubusercontent.com/sebastianpw/sg_showcase_01/main/cinemagic_hub/sg-tac/assets/frame0058067.jpg",
        "url": "ep_166_de.html"
    },
    "is_preview": false,
    "available_langs": [
