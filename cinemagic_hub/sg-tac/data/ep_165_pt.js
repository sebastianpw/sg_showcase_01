const episodeData = {
    ...
    "frames": [
        ...
        },
        {
            ...
            "overlay_texts": [
                "Estação Rain-Maker. O rendimento da manhã brilha nos medidores transparentes: 89%. Abaixo dos 94% de ontem. O declínio segue um padrão matemático que Elara reconhece como deliberado.",
                "A notícia chega através dos canais Ghost-Walker: as discussões de financiamento de Nova Terra pelo Príncipe-Comerciante Zev já não são privadas. A coligação de colonos fraturou-se tão limpa como a geada racha a pedra.",
                "A parceria Vitalis de Elara inflama-se de fúria. A harmonia que eles cantaram para existir nunca foi autêntica. Foi consentimento pré-arranjado disfarçado de ligação.",
                "O rendimento do orvalho cai. 87%. A consciência da água está a retirar o consentimento. O próprio ecossistema está a responder à quebra da aliança.",
                "Seu sinal de comunicações bloqueia. Não é falha mecânica, é silenciamento deliberado. Ela está a ser isolada. Ou protegida. Durante vários minutos, Elara não fala."
            ]
        },
        {
            "id": 9678,
        ...
        },
        {
            ...
            "overlay_texts": [
                "Crater City. Osso Arterial. Kaelen está fundido num trono de carbono escuro. Veias de energia Chrono pulsam através de carne sintética. As paredes da câmara racham numa treliça hexagonal de stress temporal.",
                "Sua mão enluvada treme. A queimadura física do Tether. Quarenta anos de negociação deixaram o tremor, a economia esquelética, o vazio atrás dos seus olhos de âmbar.",
        ...
        },
        {
            ...
            "overlay_texts": [
                "Canal-Bistro de Crater City. As paredes de obsidiana suam água mineral. Melori senta-se à cabeceira de uma mesa de fibra de junco comprimida. Cada ponta do dedo brilha com luminescência roxa suave.",
                "Ela atribui factos a três contactos. Nunca nomeando a contaminação como um padrão. Nunca ligando os três sintomas num único diagnóstico.",
                "MELORI: &quot;A Crosta reporta doença de raiz inesgotável. O Drift mostra variação de fenótipo na carga. Os tanques de algas de Vortex estão a sofrer colapso imunitário em cascata.&quot;",
                "BUROCRATA DE VORTEX: &quot;Você já conhece o padrão.&quot;\n\nMELORI: &quot;Conhecimento não é poder. Conhecimento é o pré-requisito para o poder.&quot;",
                "MELORI: &quot;Vou mostrar-lhes por que os três são insuficientes até serem integrados. Em três dias, tragam-me os vossos inventários completos.&quot;"
            ]
        },
        {
            "id": 9684,
        ...
        },
        {
            ...
            "overlay_texts": [
                ...
                "As penas do Grifo carregam agora o âmbar. Âmbar é a cor da energia Chrono. A cor da consequência. A cor do que já foi decidido quarenta anos antes da decisão ser tomada.",
                "Eve fecha os olhos. A selva acima respira no seu sono. Os esporos flutuam. As penas de âmbar mantêm-se."
            ]
        }
    ],
